...
insure.cf.HABhi.sim <- insure.list[[2]]
insure.none.HABhi.sim <- insure.list[[3]]
insure.one.HABhi.sim <- insure.list[[4]]
...
sdiv.cf.HABhi.sim <- sdiv.list[[2]]
sdiv.none.HABhi.sim <- sdiv.list[[3]]
sdiv.one.HABhi.sim <- sdiv.list[[4]]
```
...
```{r}
list3a <- list(sq.cf.HABhi.sim,insure.cf.HABhi.sim,dr1.cf.HABhi.sim,dr2.cf.HABhi.sim,sdiv.cf.HABhi.sim)
...
plot3a <- compare.models.impact.df(list3a,
...
```{r}
list3b <- list(sq.none.HABhi.sim,insure.none.HABhi.sim,dr1.none.HABhi.sim,dr2.none.HABhi.sim,sdiv.none.HABhi.sim)
names(list3b) <- c("Status Quo","Insurance","Direct Assistance Disaster Relief",
                   "Multi-Objective Disaster Relief","Supplementary Diversification")
plot3b <- compare.models.impact.df(list3b,
                                      perturb.list=list(c(`HAB`=1),
                                                           c(`HAB`=1,`insurance`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1,`disaster relief (invest)`=1),
...
```{r}
list3c <- list(sq.one.HABhi.sim,insure.one.HABhi.sim,dr1.one.HABhi.sim,dr2.one.HABhi.sim,sdiv.one.HABhi.sim)
names(list3c) <- c("Status Quo","Insurance","Direct Assistance Disaster Relief",
                   "Multi-Objective Disaster Relief","Supplementary Diversification")
plot3c <- compare.models.impact.df(list3c,
                                      perturb.list=list(c(`HAB`=1),
                                                           c(`HAB`=1,`insurance`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1,`disaster relief (invest)`=1),
...
png(here('drafts','Fig3.png'),res=200,height=1820,width=1400)
...
names(list3a) <- c("Status Quo","Insurance","Direct Assistance Disaster Relief",
                   "Multi-Objective Disaster Relief","Supplementary Diversification")
plot3a <- compare.baseline.impact.df(list3a,
                                      perturb.list=list(c(`HAB`=1),
                                                           c(`HAB`=1,`insurance`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1,`disaster relief (invest)`=1),
...
names(list3b) <- c("Status Quo","Insurance","Direct Assistance Disaster Relief",
                   "Multi-Objective Disaster Relief","Supplementary Diversification")
plot3b <- compare.baseline.impact.df(list3b,
                                      perturb.list=list(c(`HAB`=1),
                                                           c(`HAB`=1,`insurance`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1,`disaster relief (invest)`=1),
...
names(list3c) <- c("Status Quo","Insurance","Direct Assistance Disaster Relief",
                   "Multi-Objective Disaster Relief","Supplementary Diversification")
plot3c <- compare.baseline.impact.df(list3c,
                                      perturb.list=list(c(`HAB`=1),
                                                           c(`HAB`=1,`insurance`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1),
                                                           c(`HAB`=1,`disaster relief (direct)`=1,`disaster relief (invest)`=1),
...
png(here('drafts','Fig3-change.png'),res=200,height=1820,width=1400)
plot_grid(plotlist=list(p1,p2,p3),nrow=3,rel_heights=c(1,0.43,0.9),rel_widths=c(1,0.05),
