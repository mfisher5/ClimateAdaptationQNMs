...
# ---- insurance ----
insure.list <- readRDS(here('data','HAB_sim_out','Insurance_x_HABhi_50k.rds')); names(insure.list)
...
# ---- disaster relief 2 ----
dr2list <- readRDS(here('data','HAB_sim_out','DisasterRelief2_x_HABhi_50k_24Jul2025.rds')); names(dr2list)
...
sdiv.list <- readRDS(here('data','HAB_sim_out','SupplementaryDiv_x_HABhi_50k_24Jul2025.rds')); names(sdiv.list)
...
png(here('doc','drafts','Fig3-change-UPDATE2.png'),res=200,height=1820,width=1400)
