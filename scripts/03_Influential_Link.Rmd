...
saveRDS(out,here('data','HAB_sim_out','StatusQuo_x_HABhi_50k.rds'))
```
...
#---- CHOOSE ONE ----
##### Simulate a HAB
dr1.one.sim <- system.simulate(n.sims=50000, # number of randomly generated matrices to keep
...
saveRDS(sdiv_list,here('data','HAB_sim_out','SupplementaryDiv_x_HABhi_50k.rds'))
