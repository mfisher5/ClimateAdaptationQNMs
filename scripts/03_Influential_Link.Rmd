...
saveRDS(out,here('data','HAB_sim_out','InflWinterFishing_ParaInsurance_x_HABhi_50k.rds'))
```
...
read back in
```{r}
insure_list <- readRDS(here('data','HAB_sim_out','InflWinterFishing_ParaInsurance_x_HABhi_50k.rds'))
```
...
save
```{r}
out <- list(dr1.sim,dr1.wait.sim,dr1.no.sim, dr1.one.HABhi.sim)
names(out) <- c("Default","Choose one","Wait for crab","No effect")
saveRDS(out,here('data','HAB_sim_out','InflWinterFishing_DisasterRelief1_x_HABhi_50k.rds'))
rm(out)
```
...
read back in
```{r}
dr1_list <- readRDS(here('data','HAB_sim_out','InflWinterFishing_DisasterRelief1_x_HABhi_50k.rds'))
```
...
save
```{r}
out <- list(dr2.sim,dr2.wait.sim,dr2.no.sim, dr2.one.sim)
names(out) <- c("Default","Choose one","Wait for crab","No effect")
saveRDS(out,here('data','HAB_sim_out','InflWinterFishing_DisasterRelief2_x_HABhi_50k.rds'))
rm(out)
```
...
read back in
```{r}
dr2_list <- readRDS(here('data','HAB_sim_out','InflWinterFishing_DisasterRelief2_x_HABhi_50k.rds'))
```
...
save
```{r}
out <- list(sdivS.sim, sdivS.one.sim,sdivS.wait.sim,sdivS.no.sim)
names(out) <- c("Default","Choose one","Wait for crab","No effect")
saveRDS(out,here('data','HAB_sim_out','InflWinterFishing_SupplementaryDiversify_x_HABhi_50k.rds'))
rm(out)
```
...
read back in
```{r}
sdiv_list <- readRDS(here('data','HAB_sim_out','InflWinterFishing_SupplementaryDiversify_x_HABhi_50k.rds'))
```
...
tmp_list <- list(cft.HABhi.sim, cft.one.HABhi.sim, insure.sim,insure.one.HABhi.sim,
                 dr1.HABhi.sim,dr1.one.HABhi.sim,
                 dr2.HABhi.sim,dr2.one.HABhi.sim,
                 sdivS.sim,sdivS.one.HABhi.sim); names(tmp_list) <- c("Status Quo", " ---Crab Dampens SQ",
...
tmp_list <- list(cft.HABhi.sim, cft.cf.HABhi.sim,
                 insure.sim,insure.cf.HABhi.sim,
                 dr1.HABhi.sim,dr1.cf.HABhi.sim,
                 dr2.HABhi.sim,dr2.cf.HABhi.sim,
                 sdivS.sim,sdivS.cf.HABhi.sim); names(tmp_list) <- c("Status Quo", " ---Crab Facilitates SQ",
...
tmp_list <- list(cft.HABhi.sim, cft.none.HABhi.sim,
                 insure.sim,insure.none.HABhi.sim,
                 dr1.HABhi.sim,dr1.none.HABhi.sim,
                 dr2.HABhi.sim,dr2.none.HABhi.sim,
                 sdivS.sim,sdivS.none.HABhi.sim); names(tmp_list) <- c("Status Quo", " ---No Effect SQ",
