...
plot.pairs1a <- plot.pairs1[[3]] + 
  ...
  theme(legend.position="none",
        plot.margin=margin(unit(c(5.5, 100.5, 2, 5.5+s1), "points")))

plot.pairs2a <- plot.pairs2[[3]] +
  geom_vline(aes(xintercept=9.5), linewidth=0.5) +
  geom_vline(aes(xintercept=12.5), linewidth=0.5) +
  theme(legend.position="none",axis.text.x=element_blank(),
        plot.margin=margin(unit(c(-10, 100.5, 2, 5.5+s2), "points")))

plot.pairs3a <- plot.pairs3[[3]] +
  geom_vline(aes(xintercept=9.5), linewidth=0.5) +
  geom_vline(aes(xintercept=12.5), linewidth=0.5) +
  theme(legend.position="none",axis.text.x=element_blank(),
        plot.margin=margin(unit(c(-10, 100.5, 2, 5.5+s3+5), "points")))

plot.pairs4a <- plot.pairs4[[3]] +
  geom_vline(aes(xintercept=9.5), linewidth=0.5) +
  geom_vline(aes(xintercept=12.5), linewidth=0.5) +
  theme(legend.position="none",axis.text.x=element_blank(),
        plot.margin=margin(unit(c(-10, 100.5, 5, 5.5+s4+5), "points")))
```
