...
sq.costs.sim <- system.simulate(n.sims=50000, # number of randomly generated matrices to keep
...
```{r}
png(here('drafts','supplement','FigS9-feedbacks-extended.png'), res=200,height=1200,width=1400)
