...
```{r}
cft.costs.sampler <- community.ordering.sampler(m.sq.costs.constrained)
cft.costs.sim <- system.simulate(n.sims=10000, # number of randomly generated matrices to keep
                            edges=m.sq.costs, # the qnm
                            required.groups = c(0), # allow uncertain edges
                            sampler=cft.costs.sampler,
...
dr1.costs.sim <- system.simulate(n.sims=10000, # number of randomly generated matrices to keep
...
dr2.costs.sim <- system.simulate(n.sims=10000, # number of randomly generated matrices to keep
...
```{r}
sdiv.costs.sim <- system.simulate(n.sims=10000, # number of randomly generated matrices to keep
...
insure.costs.sim <- system.simulate(n.sims=10000, # number of randomly generated matrices to keep
...
div1.costs.sim <- system.simulate(n.sims=10000, # number of randomly generated matrices to keep
...
div2.costs.sim <- system.simulate(n.sims=10000, # number of randomly generated matrices to keep
...
feedback_infra_list <- list(
  cft.costs.sim, insure.costs.sim, 
...
```{r}
compare2.list <- list(sq.sim, cft.costs.sim,
