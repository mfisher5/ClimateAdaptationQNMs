---
title: "Completing a Feedback: Shoreside Infrastructure & Support Services"
author: "M Fisher"
date: "2023-01-03"
output: 
  html_document:
...
check out a strategy of interest. 
```{r}
compare1.list <- list(dr2.sim,dr2.costs.sim); 
names(compare1.list) <- c("Multi-Objective Disaster Relief","(with Feedback)  ")

compare1 <- compare.models.impact.tbl(sim.list=compare1.list,
